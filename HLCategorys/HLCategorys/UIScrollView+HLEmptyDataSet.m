...
#define kHLEmptyDataSetNoDataImage [UIScrollView hl_budleImageWithName:@"no_content_empty"]
#define kHLEmptyDataSetCustomErrorImage [UIScrollView hl_budleImageWithName:@"server_error"]
